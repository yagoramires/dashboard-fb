...
export const useInsertProduct = (docCollection) => {
  ...
  const insertProduct = async (document) => {
    ...
    try {
      ...
      const insertDocument = await addDoc(
        ...
        newProduct, // insere o documento na coleção
      );
  ...
  return { insertProduct, response }; // retorna a funcao e a resposta do reducer
};
